...
function runCmd(attempt, inputs) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    timeout = (0, inputs_1.getTimeout)(inputs);
                    end_time = timeout && Date.now() + timeout;
                ...
                case 2:
                    ...
                    _c.label = 3;
                case 3:
                    if ((!end_time || Date.now() < end_time) && !done) return [3 /*break*/, 1];
                    _c.label = 4;
                case 4:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_2 = _a.sent();
                    if (!(attempt === inputs.max_attempts)) return [3 /*break*/, 5];
                    throw new Error("Final attempt failed. ".concat(error_2.message));
                case 5:
                    if (!(!done && inputs.retry_on === 'error')) return [3 /*break*/, 6];
                    // error: timeout
                    throw error_2;
                case 6:
                    if (!(inputs.retry_on_exit_code && inputs.retry_on_exit_code !== exit)) return [3 /*break*/, 7];
                    throw error_2;
                case 7:
                    if (!(exit > 0 && inputs.retry_on === 'timeout')) return [3 /*break*/, 8];
                    // error: error
                    throw error_2;
                case 8:
...
function getInputs() {
    ...
    var max_attempts = getInputNumber('max_attempts', false) || 3;
    ...
    var retry_on_pattern = (function () {
        ...
        if (!str)
            return undefined;
        try {
            return (0, util_1.regexFromString)(str);
        }
        catch (_a) {
            return undefined;
        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.regexFromString = exports.retryWait = exports.wait = void 0;
var core_1 = __nccwpck_require__(186);
function wait(ms) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
function regexFromString(str) {
    ...
    var _b = ((_a = str.match(/^\/(?<body>.*)\/(?<flags>[gimsuy]*)$/)) === null || _a === void 0 ? void 0 : _a.groups) || {}, body = _b.body, flags = _b.flags;
